...
const AuthPage = () => {
  ...
  const { signup, login, signInWithGoogle, resendEmailVerification, currentUser } = useAuth();
            ...
            {isLogin && (
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-medium text-[#317bea] hover:text-[#317bea]/90">
