...
const SignIn = () => {
  ...
  const handleSocialLogin = (provider) => {
    // Mock social login - In a real app, you would integrate with OAuth providers
    setIsLoading(true);
    setTimeout(() => {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Or{' '}
            <Link to="/signup" className="font-medium text-custom hover:text-custom/80">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="#" className="font-medium text-custom hover:text-custom/80">
